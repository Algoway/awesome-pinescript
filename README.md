...
- [AlgoWay](https://algoway.trade/) - *TradingView webhook automation for MT5, cTrader, TradeLocker, MatchTrader, DxTrade, Capital.com, OANDA, Forex.com, IBKR, Binance, OKX, Bybit and other execution platforms.*
